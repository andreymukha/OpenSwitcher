...
**База `master`:**
`672f4c604f875ffc1cb4288884b59114829f5518`
...
1. Собрать один итоговый exact DEB из объединённого `master`.
2. Провести на нём одну объединённую финальную кампанию по границе ниже.
3. Зафиксировать итоговый acceptance/handoff без повторного расширения scope.
