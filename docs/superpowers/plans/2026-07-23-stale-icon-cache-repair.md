...
- [ ] **Шаг 1: подтвердить исходный RED**
...
- [ ] **Шаг 2: пересобрать cache из фактического содержимого темы**
...
- [ ] **Шаг 3: подтвердить GREEN через GTK**
...
- [ ] **Шаг 4: проверить границы изменения**
